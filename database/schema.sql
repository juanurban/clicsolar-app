-- SunQuote - Schema MySQL

-- Importar dentro de la base de datos MySQL seleccionada en phpMyAdmin.
-- Hostinger crea la base de datos y el usuario desde hPanel; por eso este
-- archivo no intenta ejecutar CREATE DATABASE ni USE.
...
CREATE TABLE IF NOT EXISTS proyectos (
    ...
    estado_id INT,
    estado VARCHAR(50) DEFAULT 'Evaluación',
...
CREATE TABLE IF NOT EXISTS perfiles_energeticos (
    ...
    hoja_origen VARCHAR(255),
    intervalo_minutos DECIMAL(10,2) DEFAULT 60,
    fecha_inicio DATETIME NULL,
    fecha_fin DATETIME NULL,
    numero_mediciones INT DEFAULT 0,
    consumo_total_kwh DECIMAL(14,3) DEFAULT 0,
    consumo_diario_promedio_kwh DECIMAL(14,3) DEFAULT 0,
    consumo_mensual_estimado_kwh DECIMAL(14,3) DEFAULT 0,
    demanda_promedio_kw DECIMAL(14,3) DEFAULT 0,
    demanda_maxima_kw DECIMAL(14,3) DEFAULT 0,
    produccion_total_kwh DECIMAL(14,3) DEFAULT 0,
    perfil_horario_json LONGTEXT,
    resumen_diario_json LONGTEXT,
    mediciones_json LONGTEXT,
    observaciones TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (cliente_id) REFERENCES clientes(id) ON DELETE CASCADE
