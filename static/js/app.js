...
async function updateBranding() {
    try {
        ...
        const nombreLargo = res.empresa_nombre?.valor || 'Plantas Solares de Colombia';
...
function updateSidebarForPermissions() {
    ...
    document.querySelectorAll('.superadmin-only').forEach(link => {
        link.style.display = App.user?.es_superadmin ? '' : 'none';
    });
